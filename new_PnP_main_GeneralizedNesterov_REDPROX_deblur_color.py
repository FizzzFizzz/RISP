...
def plot_psnr(denoisor_level, lamb, sigma,r):
    ...
    savepth = 'images_GNesterov_r{}'.format(r) + '/'
    ...
    plt.ylabel('PSNR')
    # plt.show()
    plt.savefig('PSNR_level{}_lamb{}_r{}_GeneralizedNestorov.png'.format(denoisor_level, lamb,r))
    plt.close()
...
# plot_psnr(denoiser_level, lamb, noise_sigma, r)
plot_psnr(0.1, 3.6, 12.75, 1) # 
